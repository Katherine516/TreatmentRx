...
from precisionrx_agent.shared.models import EstimandResult, MethodResult, StageRecord


class EstimandReporter:
    def report(self, stages: list[StageRecord], selected: MethodResult) -> list[EstimandResult]:
        n = float(len(stages))
